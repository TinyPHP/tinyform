...
(function ( )
{
    ...
    function showMsg(obj){
        ...
        var error = obj['error'];
        var alt = initmsg = (typeof(obj['msg'])=='string'&&obj['msg'].length>0)?obj['msg']:null;
        ...
        if(error){
            ...
            {
                msg.className = "invalid-msg";
                if(initmsg_attr==null || initmsg_attr=='') textfield.setAttribute('initmsg', msg.innerHTML);
            ...
            if(msg && (msg.tagName=='LABEL' || msg.tagName=='SPAN' ))
             {
                if(empty!=null && value=='')
                    ...
                    msg.className = "valid-msg";
                if(initmsg_attr==null || initmsg_attr=='') textfield.setAttribute('initmsg', msg.innerHTML);
                msg.innerHTML= initmsg || initmsg_attr || msg.innerHTML;
             }
              else
             {
                 var new_msg=document.createElement("LABEL");
                 ...
                 if(initmsg_attr==null || initmsg_attr=='') textfield.setAttribute('initmsg', '');
                new_msg.innerHTML= initmsg || initmsg_attr;
                textfield.parentNode.insertBefore(new_msg,msg);
             }
        }
    }
